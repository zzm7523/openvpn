...
rm -rf amd64
svn export https://10.5.12.12:2443/svn/despicable_me/trunk/openvpn/distro/dpkg/amd64

#update DEBIAN/control
#...

cd ${DESPICABLE_ME}/openvpn/release/amd64
...
cd ${DESPICABLE_ME}/openvpn/release
dpkg -b amd64/ openvpn_6.1.4-1+deb8u1_amd64.deb
