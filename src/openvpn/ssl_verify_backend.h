 ...
 */
result_t verify_cert (struct tls_session *session, openvpn_x509_cert_t *cert, int cert_depth, X509_STORE_CTX *ctx);
 ...
 */
void cert_hash_remember (struct tls_session *session, const int cert_depth, const unsigned char *sha1_hash);
