 ...
 */
void tls_ctx_set_options (struct tls_root_ctx *ctx, unsigned int ssl_flags, const char *tls_version);
 ...
 * 				successful.
 */
int tls_ctx_load_pkcs12 (struct tls_root_ctx *ctx, const char *pkcs12_file, const char *pkcs12_file_inline,
		bool load_ca_file);
...
#ifdef ENABLE_GUOMI
void tls_ctx_load_gmedapi (struct tls_root_ctx *ctx, const char *gmedapi_cert);
#endif
...
int tls_ctx_load_encrypt_pkcs12 (struct tls_root_ctx *ctx, const char *pkcs12_file, const char *pkcs12_file_inline);
void tls_ctx_load_encrypt_cert_file (struct tls_root_ctx *ctx, const char *cert_file, const char *cert_file_inline);
int tls_ctx_load_encrypt_priv_file (struct tls_root_ctx *ctx, const char *priv_key_file, const char *priv_key_file_inline);
 ...
 */
void show_available_tls_ciphers (const char *tls_version, const char *tls_ciphers);
