 ...
 *     header prepended.
 */
void lzo_compress (struct buffer *buf, struct buffer work, struct lzo_compress_workspace *lzowork,
...
void lzo_get_stats (int thread_idx, counter_type *pre_decompress, counter_type *post_decompress,
 ...
 */
static inline bool lzo_defined (const struct lzo_compress_workspace *lzowork)
{
