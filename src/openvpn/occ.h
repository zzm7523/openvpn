...
struct mtu_load_test
{
	...
	int delta;  /* determine packet size to send by using this delta against currently configured MTU */
};
...
void process_received_occ_msg (struct context *c, struct buffer *buf);
