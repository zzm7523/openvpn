...
int match_auth_rt_msg (const struct buffer *buf);

void incoming_push_message (struct context *c, struct buffer *buffer);

int process_incoming_push_msg (struct context *c, const struct buffer *buffer, bool honor_received_options,
