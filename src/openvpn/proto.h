 ...
 * (RFC 879, section 7).
 */
#define MTU_TO_MSS(mtu) (mtu - sizeof (struct openvpn_iphdr) - sizeof (struct openvpn_tcphdr))
...
void ipv4_packet_size_verify (const uint8_t *data, const int size, const int tunnel_type, const char *prefix,
		counter_type *errors);
#endif
