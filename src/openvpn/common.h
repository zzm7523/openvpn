...
/* these are used to cast the arguments and MUST match the formats above */
...
/*
 * This parameter controls the maximum size of a bundle of pushed options.
 */
...
/*
 * A sort of pseudo-filename for data provided inline within the configuration file.
 */
