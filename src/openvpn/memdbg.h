...
/* 
 * 用DMALLOC调试内存问题时, 编译器不能加 -Ox 优化选项; 否则编译时报错误 
 * dmalloc-5.5.2/dmalloc.h:484:错误: expected identifier of '(' before '__extension__'
 */
...
/*
 * Force buffers to be zeroed after allocation. For debugging only.
 */
