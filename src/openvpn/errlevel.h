...
/*
 * Debug level at and above where we display time to microsecond resolution.
 */
...
/*
 * Debugging levels for various kinds of output.
 */
...
#define D_PING_ERRORS        LOGLEV(1, 15, M_NONFATAL)   /* show ping errors */
