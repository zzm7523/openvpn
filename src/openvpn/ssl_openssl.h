 ...
 */
extern int global_SSL_tls_session_index; /* GLOBAL */
extern int global_SSL_key_state_index; /* GLOBAL */
extern int global_RSA_tls_session_index; /* GLOBAL */
extern int global_RSA_key_state_index; /* GLOBAL */

bool tls_version_check (const char *tls_version);
